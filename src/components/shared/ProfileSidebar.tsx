...
export const ProfileSidebar = () => {
  ...
  return (
    <div className="min-w-max bg-rose-300 rounded-3xl p-8 h-[93vh] sticky top-8">
      <p className="font-raleway text-center text-lg md:text-2xl font-semibold whitespace-nowrap dark:text-white mb-12">
      ...
      <div className="h-[88%] flex flex-col justify-between">
        <div>
          ...
          >
            ...
            <span className="ml-3 text-lg font-semibold">Blood Request</span>
          </Link>
          <Link
            href="/profile"
            className="bg-white mt-1 flex p-2 text-gray-900 rounded-xl hover:bg-[#F4F5F6]"
          >
            ...
            <span className="ml-3 text-lg font-semibold">Change Password</span>
          </Link>
        </div>
        ...
        <div>
          <Link
            href="/"
            className="bg-white flex p-2 text-gray-900 rounded-xl hover:bg-[#F4F5F6]"
          >
            <span>
              <svg
                xmlns="http://www.w3.org/2000/svg"
